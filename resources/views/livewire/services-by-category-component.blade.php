            ...
            <div>
                <div class="container">
                    <div class="portfolioContainer">
                        @if($scategory->service->count() > 0)
                        @foreach ($scategory->service as $service)


                        <div class="col-xs-6 col-sm-4 col-md-3 nature hsgrids"
                            style="padding-right: 5px;padding-left: 5px;">
                            <a class="g-list" href="{{route('home.service-details',['service_slug'=>$service->slug])}}">
                                <div class="img-hover">
                                ...
                                <div class="info-gallery">
                                    ...
                                    <hr class="separator">
                                    <p>{{$service->tagline}}</p>
                                    <div class="content-btn"><a href="{{route('home.service-details',['service_slug'=>$service->slug])}}"
