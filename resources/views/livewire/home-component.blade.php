                        ...
                        <ul id="sponsors" class="tooltip-hover">
                            @foreach ($scategory as $category)
                                ...
                                <li data-toggle="tooltip" title="{{ $category->name }}"
                                    data-original-title="{{ $category->name }}"> <a
                                        href="{{ route('home.services-by-category', ['category_slug' => $category->slug]) }}"><img
                    ...
                    <div class="portfolioContainer" style="margin-top: -50px;">
                        @foreach ($fservices as $fservice)
                            <div class="col-xs-6 col-sm-4 col-md-3 hsgrids"
                                ...
                                <a class="g-list"
                                    href="{{ route('home.service-details', ['service_slug' => $fservice->slug]) }}">
                                    <div class="img-hover">
                                    ...
                                    <div class="info-gallery">
                                        ...
                                        <div class="price">
                                            <span>&#36;</span><b>From</b>{{ $fservice->price }}
                                        </div>
                                    </div>
                                </a>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <ul class="services-lines">
                                @foreach ($fcategory as $category)
                                    <li>
                                        <a
                                            href="{{ route('home.services-by-category', ['category_slug' => $category->slug]) }}">
        ...
        <div>
            ...
            <div id="boxes-carousel">
                @foreach ($aservices as $aservice)
                    <div>
                        <a class="g-list"
                            href="{{ route('home.service-details', ['service_slug' => $aservice->slug]) }}">
                            <div class="img-hover">
