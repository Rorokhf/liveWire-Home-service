                                        ...
                                        <div class="post-header">
                                            ...
                                            <div class="post-info-wrap">
                                                <h2 class="post-title"><a href="#" title="Post Format: Standard"
                                                        rel="bookmark">{{ $service->name }} : {{$service->tagline}}</a></h2>
                        ...
                        <div class="col-md-4">
                                    ...
                                    <div class="panel-body">
                                        <table class="table">
                                            <tr>
                                                ...
                                                <td style="border-top: none;"><span>&#36;</span>{{ $service->price }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Quntity</td>
                            ...
                            <aside>
                                ...
                                <div class="col-md-12 col-sm-6 col-xs-12 bg-dark color-white padding-top-mini"
                                    ...
                                    <a href="{{route('home.service-details',['service_slug'=>$r_service->slug])}}">
                                        <div class="img-hover">
                                        ...
                                        <div class="info-gallery">
                                            ...
                                            <hr class="separator">
                                            <p>{{$r_service->name}}</p>
                                            <div class="content-btn"><a href="{{route('home.service-details',['service_slug'=>$r_service->slug])}}"
